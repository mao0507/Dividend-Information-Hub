  ...
  <AppLayout :breadcrumbs="['自選股']">
    <div class="relative flex h-full overflow-hidden">
      ...
      <aside class="w-[200px] shrink-0 border-r border-border flex flex-col p-3 gap-2 overflow-y-auto">
        ...
        <UButton size="sm" variant="secondary" class="mt-1" @click="promptNewGroup">＋ 新增分組</UButton>
      </aside>
      ...
      <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div class="shrink-0 px-4 py-2 flex flex-wrap gap-2 items-center border-b border-border">
          ...
          />
          <UButton size="sm" variant="ghost" class="font-mono text-[11px]" @click="openSearchHint">⌘K</UButton>
          <UButton size="sm" @click="showAdd = true">新增至自選</UButton>
        </div>
          ...
          <div v-if="!loading" class="space-y-4">
            ...
            >
              <div class="px-4 py-3 border-b border-border flex items-center gap-2">
                ...
                <UButton size="sm" variant="ghost" @click="deleteGroupSafe(group)">刪除分組</UButton>
              </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0 cursor-pointer" @click="goStock(item.stockCode)">
                    ...
                    <div class="flex flex-wrap gap-1 mt-0.5">
                      <UChip color="#94a3b8" bg="rgba(148,163,184,0.12)">{{ item.stock.sector }}</UChip>
                  ...
                  <UChip :color="fillChipColor(item)" bg="rgba(34,197,94,0.12)">{{ fillLabel(item) }}</UChip>
                  <UButton
                    size="sm"
                    variant="ghost"
        ...
        >
          ...
          <div class="relative w-full max-w-md bg-surface-2 border border-border-strong rounded-[var(--radius)] shadow-xl p-5 space-y-4">
            ...
            <div>
              ...
              <USelect v-model="addTargetGroupId" :options="groupSelectOptions"></USelect>
            </div>
            <input
              v-model="addQuery"
              type="text"
            ...
            <div class="flex justify-end gap-2">
              <UButton variant="secondary" @click="showAdd = false">關閉</UButton>
            </div>
          </div>
        </div>
      </Teleport>
